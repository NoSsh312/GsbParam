                            ...
                            <div class="col-md-6 info">
                                ...
                                <div class="row price">
                                    ...
                                    <label class="radio">
                                        ...
                                        <span>
                                            <div class="row"><big><b>4.4 oz.</b></big>
                                            </div>
                    ...
                    <div class="cardInfoDuProd">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 info">
                                ...
                                <div class="row price"> <label class="radio"> <input type="radio" name="size2"
                                            value="small"> <span>
                        ...
                        <div class="row lower">
                            <div class="col"> <a class="carousel-control-prev" href="#demo" data-slide="prev"><i
