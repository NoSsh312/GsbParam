     ...
     <legend>Commande</legend>
		...
		<p>
			<label for="rue">rue*</label>
			 <input id="rue" type="text" name="rue" value="<?php echo $rue ?>" size="30" maxlength="58">
		</p>
		<p>
      ...
      <p>
         ...
         <input id="ville" type="text" name="ville"  value="<?php echo $ville ?>" size="1" maxlength="50">
      </p>
      <p>
         <label for="mail">mail* </label>
         <input id="mail" type="text"  name="mail" value="<?php echo $mail ?>" size ="25" maxlength="254">
      </p> 
	  	<p>
