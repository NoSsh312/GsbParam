<div id="AjoutDUnProd">
   ...
   <div class="form-group row">
      <label for="ajoutIdCategorie" class="col-sm-3 col-form-label">Catégorie*</label>
      <div class="col-sm-10">
         <select class="form-control" id="ajoutIdCategorie" name="ajoutIdCategorie" required>
            <option value="">Sélectionnez une catégorie</option>
            <?php 
            foreach($lesCategories as $uneCat){
               $catID = $uneCat['id'];
               $catlib = $uneCat['libelle'];
               ?> 
